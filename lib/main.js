...
function buildWidget() {
    ...
    widget = require("sdk/widget").Widget({
        id: "jid0-GaZOxvWNYcafEsmayJDIG3XXVi8",
        label: "Eliminator Slajdów",
        contentURL: self.data.url("icon_48_disabled.png"),
        panel: settingsPanel
    });
    iconStatus = true;
}
...
function updateWidgetState(tab) {
    ...
    view.contentURL = data.url("icon_48_disabled.png");
    //iconStatus = false;
    //widget.destroy();    
}
...
if(isXULAvailable()){        
    ...
    tabs.on('activate', function(tab){
        console.log("ES TAB ACTICVATED !!!");
        updateWidgetState(tab);
    });    
